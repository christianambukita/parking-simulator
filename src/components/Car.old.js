...
import { goBackward, goForward, setAngleLeft, setAngleRight } from "./redux/SceneSlice"
...
export default function Car(){
    ...
    function getWheelDistance(){
        const wheelFrontLeft = document.getElementById("wheel-fl").getBoundingClientRect();
        const wheelBackRight = document.getElementById("wheel-br").getBoundingClientRect();
        let newDistance = {
    ...
    function getCarTranslation(){
        ...
        let {x, y} = translation
        return {transform: `translate(${x}px,${y}px) rotate(${rotationAngle}deg)`}
    }

    function getRearAxis(){
        const {rotationAngle: BETA} = carPositionTranslation
        const wheelRearLeft = document.getElementById("wheel-bl").getBoundingClientRect();
        const wheelRearRight = document.getElementById("wheel-br").getBoundingClientRect();
    ...
    return(
        ...
        <div id="wheel-fl" className="wheel w-left w-front" style={wheelRotationAngle}></div>
        <div id="wheel-fr" className="wheel w-right w-front" style={wheelRotationAngle}></div>
